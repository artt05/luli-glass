function sendAjaxRequest() {
  ...
  const data = `heightMeters=${heightMeters}&heightCentimeters=${heightCentimeters}&heightMillimeters=${heightMillimeters}&widthMeters=${widthMeters}&widthCentimeters=${widthCentimeters}&widthMillimeters=${widthMillimeters}&thickness=${thickness}&borderRadius=${borderRadius}&quantity=${quantity}`;
  xhr.send(data);
